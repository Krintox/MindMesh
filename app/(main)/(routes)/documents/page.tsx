...
const DocumentsPage = () => {
  ...
  const pageTitle = `${user?.firstName || "User"}'s Documents - MindMesh`;
  const pageDescription = `Welcome to ${user?.firstName || "User"}'s MindMesh, where you can create and manage your documents effortlessly.`;
    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen py-2">
        <h2 className="text-2xl font-bold mb-4">
          Welcome to {user?.firstName || "User"}&apos;s MindMesh
        </h2>
